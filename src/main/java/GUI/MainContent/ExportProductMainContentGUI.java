...
public final class ExportProductMainContentGUI extends JPanel implements ReloadablePanel{
    ...
    private UITextField txtSoLuong, txtMaPX, txtMaNV, txtTongTien, txtSdtKH, txtTenKH;
    private JComboBox<String> cbFilterChiTietSanPham;
    ...
    public ExportProductMainContentGUI(TaiKhoanDTO taiKhoan) {
       ...
       //===============================( Panel Header )================================//
        ...
        pnlFormNorth.add(new UILabel("SĐT khách hàng:", 120, 25));
        txtSdtKH = new UITextField(520,25);
        pnlFormNorth.add(txtSdtKH);
        
        pnlFormNorth.add(new UILabel("Tên khách hàng:", 120, 25));
        txtTenKH = new UITextField(520,25);
        ...
        pnlGroupTongTien.add(new UILabel("Tổng thành tiền:",120,25));
    ...
    private void addToTableForForm() {
        ...
        String tenSp = sanPhamBUS.getById(maSp).getTenSP();
        int giaBan = sanPhamBUS.getById(maSp).getGiaSP();
    ...
    private void resetFormInput(){  
        txtMaPX.setText(phieuXuatBUS.getNextExportID());
